...
/datum/map/nova
	...
	zlevel_datum_type = /datum/map_z_level/nova
	...
	default_skybox = /datum/skybox_settings/nova
...
/datum/map/nova/get_map_levels(var/srcz, var/long_range = TRUE)
...
/datum/map/nova/perform_map_generation()
...
/datum/map_z_level/nova/station/station_two
...
/datum/map_z_level/nova/station/station_three
...
/datum/map_z_level/nova/empty_space
	z = Z_LEVEL_EMPTY_SPACE
	name = "Empty"
	flags = MAP_LEVEL_PLAYER
	transit_chance = 76

/datum/map_z_level/nova/surface
	z = Z_LEVEL_SURFACE
	name = "Plains"
	flags = MAP_LEVEL_STATION|MAP_LEVEL_CONTACT|MAP_LEVEL_PLAYER|MAP_LEVEL_SEALED
	base_turf = /turf/simulated/floor/outdoors/rocks

/datum/map_z_level/nova/surface_mine
	z = Z_LEVEL_SURFACE_MINE
	name = "Mountains"
	flags = MAP_LEVEL_STATION|MAP_LEVEL_CONTACT|MAP_LEVEL_PLAYER|MAP_LEVEL_SEALED
	base_turf = /turf/simulated/floor/outdoors/rocks

/datum/map_z_level/nova/surface_wild
	z = Z_LEVEL_SURFACE_WILD
	name = "Wilderness"
	flags = MAP_LEVEL_PLAYER|MAP_LEVEL_SEALED
	base_turf = /turf/simulated/floor/outdoors/rocks

/datum/map_z_level/nova/misc
	z = Z_LEVEL_MISC
	name = "Misc"
	flags = MAP_LEVEL_PLAYER
	transit_chance = 6

/datum/map_z_level/nova/centcom
	z = Z_LEVEL_CENTCOM
	name = "Centcom"
	flags = MAP_LEVEL_ADMIN|MAP_LEVEL_CONTACT

/datum/map_z_level/nova/transit
	z = Z_LEVEL_TRANSIT
	name = "Transit"
