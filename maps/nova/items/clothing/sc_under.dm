...
/obj/item/clothing/under/rank/pilot1
	...
	icon_state = "pilot1"
	worn_state = "pilot1"
	item_icons = list(slot_w_uniform_str = 'maps/nova/icons/mob/sc_under.dmi')
	icon = 'maps/nova/icons/obj/sc_uniforms.dmi'
	sprite_sheets = list(
			"Teshari" = 'maps/nova/icons/mob/species/teshari/sc_uniform.dmi'
			)
