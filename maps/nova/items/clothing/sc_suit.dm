...
/obj/item/clothing/suit/storage/toggle/bomber/pilot
	...
	item_icons = list(slot_wear_suit_str = 'maps/nova/icons/mob/sc_suit.dmi')
	item_state_slots = list(slot_r_hand_str = "brown_jacket", slot_l_hand_str = "brown_jacket")
	icon = 'maps/nova/icons/obj/sc_suit.dmi'
	sprite_sheets = list(
			"Teshari" = 'maps/nova/icons/mob/species/teshari/sc_suit.dmi'
			)
